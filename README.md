...
`10001101.11101111.11100101.00_000000` = `141.239.229.0/26` routed by I  
`10001101.11101111.11100101.00_000001` = `141.239.229.1` routed by I, min  
`10001101.11101111.11100101.00_111110` = `141.239.229.63` routed by I, max  
...
`10100011.10101010.11111010.0000_0001` = `163.170.250.1` = network R1 R2 min ...  
`10100011.10101010.11111010.0000_1110` = `163.170.250.14` = network R1 R2 max    
