...
`01000101.00100000.01110110.10+000001` (`69.32.118.128`) B1, R min (B1, R1, A1 are in the same network)   
...
`00001010.00000000.00000000.0000+0000` (`10.0.0.0`) table R    
`10100011.10101100.11111010.0000+0001` (`163.172.250.1`) table R   
