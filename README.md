...
|A: send to A1              |B: send to gateway 170.242.21.254 through interface B1 |A: send to gateway 17.33.126.126 through interface A1 |
|                           |                                                       |R: packet accepted                                    |
|                           |                                                       |R: send to R2                                         |
|R: packet accepted         |R: packet accepted                                     |B: packet accepted                                    |
|R: destination IP reached  |R: destination IP reached                              |B: destination IP reached                             |
|**R -> A (17.33.126.125)** |**R -> B (170.242.21.253)**                            |**B -> A (17.33.126.125)**                            |
|R: packet accepted         |R: packet accepted                                     |B: packet accepted                                    |
|                           |                                                       |B: dest. does not match any interface, routing table  |
|                           |                                                       |B: route match default                                |
|R: send to R1              |R: send to R2                                          |B: send to gateway 170.242.21.254 through interface B1| 
|                           |                                                       |R: packet accepted                                    |
|                           |                                                       |R: send to R1                                         |
|A: packet accepted         |B: packet accepted                                     |A: packet accepted                                    | 
|A: destination IP reached  |B: destination IP reached                              |A: destination IP reached                             |
