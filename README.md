...
Network C + D + R2:    
`11111111.11111111.11111111.1111+0000` (`255.255.255.240`, `/28`) mask  
`10001101.11101111.11100101.1111+0001` (`141.239.229.241`) min, R23 (R2)  
`10001101.11101111.11100101.1111+0010` (`141.239.229.242`) R22 (R2)  
...
`10001101.11101111.11100101.00+000000` (`141.239.229.0/26`) table I
  
Network R1 + R2:    
`11111111.11111111.11111111.11+000000` (`255.255.255.192`, `/26`) mask 
`10001101.11101111.11100101.00+000001` (`141.239.229.1`) min  
`10001101.11101111.11100101.00+111101` (`141.239.229.61`) R21 (R2)
`10001101.11101111.11100101.00+111110` (`141.239.229.62`) max, R13 (R1)   

Network R2 + Internet:    
`11111111.11111111.11111111.1111+0000` (`255.255.255.240`, `/28`) mask  
`10100011.10101010.11111010.0000+0001` (`163.170.250.1`) min, R1 table  
`10100011.10101010.11111010.0000+1100` (`163.170.250.12`) R12 (R1)   
