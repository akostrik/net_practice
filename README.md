...
$\textsf{\color{blue}`11000000.10101000.0000000`}$ - $\textsf{\color{green}`1.00000010`}$ (`192.168.1.2`) IP = $\textsf{\color{blue}network prefix}$ + $\textsf{\color{green}диапазон адресов устройств в сети, host identifie}$  
