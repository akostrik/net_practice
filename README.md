...
`10001100.10111110.01010011.11000000`=`140.190.083.192` free, can be used for network R2 C3  
...    
`10001100.10111110.01010011.11111011`=`140.190.083.251` free, can be used for network R2 C3     
