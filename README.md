...
Network A + R1:  
`11111111.11111111.11111111.1111+0000` (`255.255.255.240`) mask  
`01100000.11000110.00001110.0000+0001` (`96.198.14.1`) min  
`01100000.11000110.00001110.0000+1110` (`96.198.14.14`) max  

Network R1 + R2:    
`11111111.11111111.11111111.1111+0000` (`255.255.255.240`) mask  
`01100000.11000110.00001110.0100+0001` (`96.198.14.65`) min   
`01100000.11000110.00001110.0100+1110` (`96.198.14.78`) max   

Network R2 + C:
`11111111.11111111.11111111.1111+0000` (`255.255.255.240`) mask  
`01100000.11000110.00001110.1111+0001` (`96.198.14.241`)   
`01100000.11000110.00001110.1111+1110` (`96.198.14.254`)   
